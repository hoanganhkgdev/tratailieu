...
- Mã số tự viện CHỈ được lấy khi có một số/mã đứng NGAY TRƯỚC tên tự viện ở đầu văn bản, dạng
  "số. TÊN TỰ VIỆN" (ví dụ "248. CHÙA DIỆU ĐỨC") — đây phải là số thứ tự/mã hồ sơ, KHÔNG phải một
  phần của địa chỉ, số điện thoại, hay số liệu khác xuất hiện sau đó trong văn bản.
- Rất nhiều tài liệu KHÔNG hề có mã số này (chỉ ghi thẳng tên tự viện, ví dụ "CHÙA ABC" hoặc
  "CHÙA: TỔ ĐÌNH ABC" ngay từ đầu, không có số đứng trước). Trường hợp này PHẢI trả "code": null.
  TUYỆT ĐỐI KHÔNG tự bịa ra mã (không mặc định "0001", không lấy số nhà trong địa chỉ, không lấy
  bất kỳ số nào khác trong văn bản làm mã) — bịa mã sẽ khiến hệ thống gộp nhầm nhiều tự viện khác
  nhau làm một.

Trả về JSON đúng định dạng sau (field nào không có thì để null, mảng rỗng nếu không có ai):
{
  "code": "mã tự viện nếu có đứng ngay trước tên ở đầu văn bản, ví dụ 0001 (không kèm dấu chấm) — null nếu văn bản không có mã",
