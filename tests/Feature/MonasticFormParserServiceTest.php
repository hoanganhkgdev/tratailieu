...
TEXT;
    ...
    public function test_parses_all_fields_correctly_from_real_sample(): void
    {
        ...
        // KHÔNG tự đoán tên tự viện/tỉnh từ "current_address" — dò chuỗi con dễ trùng
        // nhầm địa danh con (đã gặp thực tế: "Ninh Thuận" là 1 ấp lại trùng alias tỉnh
        // Khánh Hòa sau đợt sáp nhập tỉnh). Để trống, admin gán tay khi cần.
        $this->assertNull($data['temple_name']);
        $this->assertNull($data['province_name']);
    }
