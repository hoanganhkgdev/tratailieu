    ...
    <div class="flex min-w-0 flex-1 flex-col bg-white">
        <header class="flex items-center gap-3 border-b border-stone-200 px-3 py-3 sm:px-6">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="truncate text-xs text-stone-500">Hỏi theo họ tên, pháp danh, số điện thoại, CCCD...</p>
            </div>
                ...
                @empty
                    <div class="mt-10 flex flex-col items-center gap-4 text-center">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-stone-500">Ví dụ: "Thích Minh Nhẫn", "SĐT của Huỳnh Huệ Hưng?", "CCCD 091094018475"</p>
                        </div>
                        ...
                        <div class="w-full max-w-md rounded-2xl border border-stone-200 bg-stone-50 p-4 text-left text-sm text-stone-600">
                            ...
                            <ul class="mt-2 list-disc space-y-1.5 pl-4">
                                <li>Tìm được theo: <strong>họ tên</strong>, <strong>pháp danh</strong>, <strong>số điện thoại</strong>, hoặc <strong>số CCCD</strong>.</li>
                                <li>Cần gõ tương đối chính xác (đúng dấu tiếng Việt) — không đoán ý gần giống.</li>
                                <li>Trùng tên ở nhiều nơi? Gõ kèm <strong>tên tỉnh</strong> để lọc.</li>
